...
public class Draw
{
    ...
    public int checkWin8(Integer[] nums)
    {
        ...
        int division2 = checkWin7(new Integer[]{nums[0],nums[1],nums[2],nums[3],nums[4],nums[5],nums[7]});
        int division3 = checkWin7(new Integer[]{nums[0],nums[1],nums[2],nums[3],nums[4],nums[7],nums[6]});
        int division4 = checkWin7(new Integer[]{nums[0],nums[1],nums[2],nums[3],nums[7],nums[5],nums[6]});
        int division5 = checkWin7(new Integer[]{nums[0],nums[1],nums[2],nums[7],nums[4],nums[5],nums[6]});
        int division6 = checkWin7(new Integer[]{nums[0],nums[1],nums[7],nums[3],nums[4],nums[5],nums[6]});
        int division7 = checkWin7(new Integer[]{nums[0],nums[7],nums[2],nums[3],nums[4],nums[5],nums[6]});
        int division8 = checkWin7(new Integer[]{nums[7],nums[1],nums[2],nums[3],nums[4],nums[5],nums[6]});

        return division1+division2+division3+division4+division5+division6+division7+division8;
    }

    public int checkWin7(Integer[] nums)
    {
